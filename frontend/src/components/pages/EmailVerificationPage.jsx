...
const EmailVerificationPage = () => {
  ...
  return (
    ...
    >
    <h2
    className="text-3xl font-bold mb-6 11text-center bg-gradient-to-r from-green-400 to-emerald-500
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <motion.button
          ...
          rounded-lg shadow-lg hover:from-green-600
          hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50
          disabled:opacity-50'
          >
